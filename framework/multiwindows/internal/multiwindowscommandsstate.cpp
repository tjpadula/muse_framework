...
#include "multiwindowscommandsstate.h"
...
std::string MultiWindowsCommandsState::moduleName() const
{
    return "multiwindows";
}

void MultiWindowsCommandsState::init()
{
...
void MultiWindowsCommandsState::deinit()
{
}

void MultiWindowsCommandsState::updateCommandStates(const std::vector<Command>& commands)
{
    IF_ASSERT_FAILED(m_moduleRegister) {
        return;
    }
...
CommandState MultiWindowsCommandsState::commandState(const Command&) const
{
    return CommandState(true, false);
}

async::Channel<Command, CommandState> MultiWindowsCommandsState::commandStateChanged() const
{

...
#include "../iextensioncontextresolver.h"

namespace muse::extensions {
class ExtensionsCommandsState : public muse::rcommand::IModuleCommandsState, public muse::Contextable, public muse::async::Asyncable
{
    muse::GlobalInject<muse::rcommand::ICommandsRegister> commandsRegister;
    muse::GlobalInject<IExtensionsRegister> extensionsRegister;
    muse::ContextInject<IExtensionContextResolver> contextResolver = { this };

public:
    ExtensionsCommandsState(const muse::modularity::ContextPtr& ctx)

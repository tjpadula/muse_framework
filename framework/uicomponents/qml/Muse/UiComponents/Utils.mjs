...
export function accessibleColorDescription(color) {
...
export function ensureContentVisible(flickable, contentRect, margins) {
...
export function getItem(model, index) {
    if (!Boolean(model)) {
        return null
    }
...
export function getItemValue(model, index, roleName, def) {

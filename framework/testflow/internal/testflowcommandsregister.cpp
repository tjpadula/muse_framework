...
#include "testflowcommandsregister.h"
...
static const std::vector<CommandInfo> s_commandInfos = {
    CommandInfo{
        TESTFLOW_OPEN_SCRIPTS_COMMAND,
        TranslatableString("testflow", "Show scripts"),
        TranslatableString("testflow", "Show scripts…"),
        InputSchema(),
        Decoration()
    },
...
std::string TestflowCommandsRegister::moduleName() const
{
    return "testflow";
}

const std::vector<muse::rcommand::Command>& TestflowCommandsRegister::commandList() const
{
...
const std::vector<CommandInfo>& TestflowCommandsRegister::commandInfoList() const
{

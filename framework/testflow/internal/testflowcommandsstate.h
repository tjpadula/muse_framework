...
class TestflowCommandsState : public muse::rcommand::IModuleCommandsState, public muse::Contextable
{
    muse::GlobalInject<muse::rcommand::ICommandsRegister> commandsRegister;

public:
    TestflowCommandsState(const muse::modularity::ContextPtr& ctx)

...
#include "diagnosticscommandsstate.h"
...
std::string DiagnosticsCommandsState::moduleName() const
{
    return "diagnostics";
}

void DiagnosticsCommandsState::init()
{
...
void DiagnosticsCommandsState::deinit()
{
}

void DiagnosticsCommandsState::updateCommandStates(const std::vector<Command>& commands)
{
    IF_ASSERT_FAILED(m_moduleRegister) {
        return;
    }
...
CommandState DiagnosticsCommandsState::commandState(const Command&) const
{
    return CommandState(true, false);
}

async::Channel<Command, CommandState> DiagnosticsCommandsState::commandStateChanged() const
{

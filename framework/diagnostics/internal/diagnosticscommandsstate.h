...
class DiagnosticsCommandsState : public muse::rcommand::IModuleCommandsState, public muse::Contextable
{
    muse::GlobalInject<muse::rcommand::ICommandsRegister> commandsRegister;

public:
    DiagnosticsCommandsState(const muse::modularity::ContextPtr& ctx)

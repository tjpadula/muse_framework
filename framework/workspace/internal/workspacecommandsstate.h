...
class WorkspaceCommandsState : public muse::rcommand::IModuleCommandsState, public muse::Contextable
{
    muse::GlobalInject<muse::rcommand::ICommandsRegister> commandsRegister;

public:
    WorkspaceCommandsState(const muse::modularity::ContextPtr& ctx)

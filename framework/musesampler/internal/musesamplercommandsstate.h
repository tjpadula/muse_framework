...
class MuseSamplerCommandsState : public muse::rcommand::IModuleCommandsState, public muse::Contextable
{
    muse::GlobalInject<muse::rcommand::ICommandsRegister> commandsRegister;

public:
    MuseSamplerCommandsState(const muse::modularity::ContextPtr& ctx)

...
namespace muse::ui {
class NavigationCommandsState : public muse::rcommand::IModuleCommandsState, public muse::Contextable
{
public:
    NavigationCommandsState(const muse::modularity::ContextPtr& ctx)
